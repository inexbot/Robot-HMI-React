...
function Place(props) {
  ...
  const [VisionDatumPoint, setVisionDatumPoint] = useState(
    props.PlaceList.position.datumPoint
  );
  const [VisionCameraPoint, setVisionCameraPoint] = useState(
    props.PlaceList.position.cameraPoint
  );
  const [VisionXexcursion, setVisionXexcursion] = useState(
    props.PlaceList.position.excursion.Xexcursion
  );
  const [VisionYexcursion, setVisionYexcursion] = useState(
    props.PlaceList.position.excursion.Yexcursion
  );
  const [VisionZexcursion, setVisionZexcursion] = useState(
    props.PlaceList.position.excursion.Zexcursion
  );
  const [VisionAngle, setVisionAngle] = useState(
    props.PlaceList.position.excursion.angle
  );
  const [VisionScale, setVisionScale] = useState(
    props.PlaceList.position.scale
  );
  const [VisionAngleDirection, setVisionAngleDirection] = useState(
    props.PlaceList.position.angleDirection
  );
  const [VisionCameraPoint2, setVisionCameraPoint2] = useState(
    props.PlaceList.position.cameraPoint[2]
  );
  const [VisionSampleData, setVisionSampleData] = useState(
    props.PlaceList.position.sampleData
  );
  ...
  const cameradata = [
    ...
    },
    {
      ...
      value: (
        <Input
          value={VisionCameraPoint2}
          onChange={(e) => {
            setVisionCameraPoint2(e.target.value);
    ...
    <div>
      ...
      >
        ...
        <div className="place-content-r">
          <div className="place-content-rt">高度可手写</div>
