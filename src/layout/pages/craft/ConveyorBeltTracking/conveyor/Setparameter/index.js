      ...
      <div>
        <HashRouter>
          ...
          <NavLink
            ...
            className="nav"
            to="/setparameter/basic"
          >
            <Button
              type={RouterBtn == "basic" ? "primary" : ""}
          ...
          <ArrowRightOutlined
            style={{ width: "6%", fontSize: "30px", textAlign: "center" }}
          />
          <NavLink
            exact
            activeClassName="selected"
            className="nav"
            to="/setparameter/discern"
          >
            <Button
              type={RouterBtn == "discern" ? "primary" : ""}
              style={{ width: "15%", height: "30px" }}
              onClick={() => {
                setCurrent(1);
              }}
          ...
          <NavLink
            ...
            activeClassName="selected"
            className="nav"
            to="/setparameter/conveyorsign"
          >
            <Button
              type={RouterBtn == "conveyorsign" ? "primary" : ""}
              style={{ width: "15%", height: "30px" }}
              onClick={() => {
                setCurrent(2);
              }}
          ...
          <NavLink
            ...
            activeClassName="selected"
            className="nav"
            to="/setparameter/sensorsign"
          >
            <Button
              type={RouterBtn == "sensorsign" ? "primary" : ""}
              style={{ width: "15%", height: "30px" }}
              onClick={() => {
                setCurrent(3);
              }}
          ...
          <NavLink
            ...
            activeClassName="selected"
            className="nav"
            to="/setparameter/setsite"
          >
            <Button
              type={RouterBtn == "setsite" ? "primary" : ""}
              style={{ width: "15%", height: "30px" }}
              onClick={() => {
                setCurrent(4);
              }}
